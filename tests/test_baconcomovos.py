...
class TestBaconComOvos(unittest.TestCase):
    ...
    def test_bacon_com_ovos_deve_retornar_bacon_se_entrada_so_for_multiplo_de_3(self):
    ...
    def test_bacon_com_ovos_deve_retornar_ovos_se_entrada_so_for_multiplo_de_5(self):
